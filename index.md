...
Below is a snippet of code from the project file [gpiointerrupt.c](https://github.com/shmoe/SNHU-CS-350/blob/master/CS-350%207-1%20Project/gpiointerrupt.c) featuring the main event loop and task scheduler. I believe this snippet is an example of simple, clean, and well documented code that exemplifies the project.
